 ...
 */
@MapperScan(basePackages = "com.juphoon.app.mapper",sqlSessionFactoryRef = "portalSqlSessionFactory")
public class DruidPortalConfig implements EnvironmentAware {

    private RelaxedPropertyResolver propertyResolver;

    public void setEnvironment(Environment env) {
        this.propertyResolver = new RelaxedPropertyResolver(env, "portal.datasource.");
    }
    ...
    @Bean(name = "portalFilterRegistrationBean")
    ...
    @Bean(value = "portalDruidStatInterceptor")
    public DruidStatInterceptor DruidStatInterceptor() {
        DruidStatInterceptor druidStatInterceptor = new DruidStatInterceptor();
        return druidStatInterceptor;
    }

    @Bean(name = "portalBeanNameAutoProxyCreator")
    public BeanNameAutoProxyCreator beanNameAutoProxyCreator() {
        BeanNameAutoProxyCreator beanNameAutoProxyCreator = new BeanNameAutoProxyCreator();
        beanNameAutoProxyCreator.setProxyTargetClass(true);
        // 设置要监控的bean的id
        //beanNameAutoProxyCreator.setBeanNames("sysRoleMapper","loginController");
        beanNameAutoProxyCreator.setInterceptorNames("portalDruidStatInterceptor");
        return beanNameAutoProxyCreator;
    }

    //数据源事务管理器
    @Bean(name="portalDataSourceTransactionManager")
    ...
    public SqlSessionFactory messageSqlSessionFactory(@Qualifier("portalDataSource") DataSource clusterDataSource) throws Exception{
